                          ...
                          Container(
                            ...
                            child: Obx(() => ListView.separated(
                                  ...
                                  itemBuilder: (context, index) {
                                    Job job = controller.recommendedJobs[index];
                                    print(
                                        'the length of the recom list is : ${controller.recommendedJobs.length}');
                                    return ListuserItemWidget(
                                      job: job,
                                      freelancerId:
                                          controller.freelancer.value?.uid ??
                                              '',
                                    );
                                  },
                                )),
                          ...
                          SizedBox(
                            ...
                            child: Obx(
                              () => controller.isLoading.value
                                  ...
                                  : ListView.builder(
                                      itemCount:
                                          controller.filteredJobsList.length,
                                      itemBuilder: (context, index) {
